...
//   };
//
//   // Function to generate QR code with ample vertical padding and spacing
//   const generateBrandedQR = async (attendee: AttendeeRecord) => {
//     const canvas = document.createElement("canvas");
//     const ctx = canvas.getContext("2d");
//
//     // Expanded vertical dimensions (600x800 portrait layout)
//     const width = 600;
//     const height = 800;
//
//     // Adjusted QR dimensions to fit comfortably with generous padding
//     const qrSize = 380;
//     const sidePadding = (width - qrSize) / 2; // Centers QR horizontally (110px margins)
//
//     canvas.width = width;
...
//
//     // --- HEADER SECTION (Top Padding: 40px) ---
...
//       qrImage.onload = () => {
//         // --- BODY SECTION (QR Y-position: 180px gives ~65px space below header) ---
//         const x = sidePadding;
//         const y = 180;
//         ctx.drawImage(qrImage, x, y, qrSize, qrSize);
//
//         // --- FOOTER SECTION (Bottom Padding: 45px space from edge) ---
//         ctx.fillStyle = "#5b1e2e";
...
//       }
//
//       toast.success("Registration successful! Your QR code is ready and sent to your email.");
//     } catch (error: unknown) {
//       const message =
